...
pkgdatadir = $(datadir)/cips
pkglibdir = $(libdir)/cips
pkgincludedir = $(includedir)/cips
top_builddir = .
...
ACLOCAL = ${SHELL} /opt/code/cips-0.0.5/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /opt/code/cips-0.0.5/missing --run tar
AM_CXXFLAGS = 
AM_LDFLAGS = -L/usr/lib64 -L/lib64 -lz -lssl -lcrypto 
AUTOCONF = ${SHELL} /opt/code/cips-0.0.5/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/code/cips-0.0.5/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/code/cips-0.0.5/missing --run automake-1.9
AWK = gawk
CC = gcc
...
MAKEINFO = ${SHELL} /opt/code/cips-0.0.5/missing --run makeinfo
MKDIR_P = $(mkdir_p)
OBJEXT = o
PACKAGE = cips
PACKAGE_BUGREPORT = 
...
infodir = ${prefix}/info
install_sh = /opt/code/cips-0.0.5/install-sh
